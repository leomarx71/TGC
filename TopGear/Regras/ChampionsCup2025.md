...
4.1. O Sorteio será realizado após confirmação das inscrições;

4.2. A fase de grupos começará 16/12/2025 e terá prazo previsto até às 23h59 do dia 23/12/2025;

4.3. O prazo para realização da Final será até às 23h59 do dia 30/12/2025;

**Observação:** As rodadas podem ter o prazo estendido caso a administração julgue necessário.

# **5. Organização e Chaveamento:** #

5.1. Será utilizado o TOORNAMENT para chaveamento das partidas [ChampionsCup2025](https://play.toornament.com/en_US/tournaments/2371177874563942399/);

6.2. O campeonato terá uma fase de grupos e os vencedores de cada grupo se enfrentam em uma final de jogo único;

5.3. Carro Livre na Fase de Grupos;

5.4. Será utilizado o sistema de comissário eletrônico na Final. Deverá o piloto usar as 4 cores, sendo 1 carro a cada 2 países.

5.4.1. O Comissário pode ser acessado aqui [Comissario](https://topgearchampionships.com/comissario/envio_la_liga.php)

5.4.2. É necessário informar o carro que será utilizado para cada país na final full game sendo R1 = USA, R8 = UK e R9 o Desempate , podendo informar até o momento antes de  começar a partida;

5.4.4. O descumprimento desse procedimento resulta em perda de partida;

5.5. Serão sorteados 3 países para cada rodada na fase de grupos;

5.6. Na final, serão sorteada apenas a ordem do full game a ser jogada;

5.7. As demais posições de 3° à 10° serão atribuídas automaticamente conforme o desempenho obtido na fase de grupos, sendo os critérios para desempate o confronto direto, pontos conquistados, saldo de pontos, e outros, conforme comunicado pela organização;

5.8. Em caso de empate reinicia-se a ROM e joga a partir do país sorteado para desempate:
...
5.9. Durante o campeonato não haverá substituição de jogadores, aqueles que desistirem, receberão w.o para todas as suas partidas.
