...
## **TGC Pole Position ZSNES 2026 - REGRAS ESPECÍFICAS** ##

## **LEIA TODAS AS REGRAS COM BASTANTE ATENÇÃO!!!** ##

## **1. CRONOGRAMA** ##

1.1 - Rodadas sempre com prazo de 7 dias (Normalmente de terça 0h até segunda-feira 23h59).

1.2 - Poderá haver 3 Rodadas com prazo de 15 dias (quando não concorrência com outros torneios).

**Observação:** As rodadas podem ter o prazo estendido caso a administração julgue necessário ou para validação dos tempos
...
### 2.1 Plataforma
Será utilizado o TOORNAMENT/Challonge para chaveamento das partidas.
...
Carro **LIVRE** em todo o campeonato.
...
### 3.1 Sistema de Pontos do Torneio
Apesar de o campeão do torneio não ter vaga na copa dos campeões da TGC, este torneio valerá pontuação para o mundial de pilotos de 2026 e assim para os 10 melhores será acrescida a pontuação a seguir:
...
- 3° Menor tempo total, somando todas as rodadas;
...
### 3.3 Sistema de Pontos da Rodada
A classificação se dará pelo menor tempo total em cada rodada e igual ao pontos do jogo
...
- Em caso de empate de tempos dentro de uma rodada, ambos os pilotos receberão a mesma posição/pontuação.
